...
export const CameraReminderModal = (props: Props) => {
  ...
  const clear = async () => {
    setIsVisible(false);
    await SecureStore.setItem(StorageKeys.CAMERA_PERMISSION_REMINDED, 'true');
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Icon name='camera' size={ICON_SIZE.xxl} marginBottom='xs' />

        <Text textAlign='center' variant='poppins_m' marginBottom='2xs'>
          {t('forgot_turn_camera_on')}
        </Text>
